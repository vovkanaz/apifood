...
TeleNotify::TelegramUser.configure_home_url("https://localhost:3000")
...
TeleNotify::TelegramUser.configure_dev_url("https://83d1665a.ngrok.io")

#Set your Telegram Bot API token here
#Don't have your token yet? Create your bot using https://telegram.me/botfather
TeleNotify::TelegramUser.configure_token("159528223:AAFA-XoRiLy3-fYxKWDdwZy6hacbsKKJox4")

...
User::Models.configure_home_url("https://localhost:3000")
...
User::Models.configure_dev_url("https://984be01d.ngrok.io")


#Set your Telegram Bot API token here
#Don't have your token yet? Create your bot using https://telegram.me/botfather
User::Models.configure_token("159528223:AAFA-XoRiLy3-fYxKWDdwZy6hacbsKKJox4")
